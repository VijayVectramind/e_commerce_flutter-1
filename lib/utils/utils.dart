...
const secureKey = "Gr3@tW@t3rS@lt@1B2c3D4e5F6g7H8";

String secureEncrypt(String plainText) {
  try {
    final salt = _genRandomWithNonZero(8);
    var keyndIV = _deriveKeyAndIV(secureKey, salt);
...
String secureDecrypt(String encrypted) {
  try {
