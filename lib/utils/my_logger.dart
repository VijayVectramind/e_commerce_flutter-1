...
class MyLogger {
  ...
  static int getLogLevel() {
    MyLogger.i("Current Log Level is ${_getPriorityText(_currentLogLevel)}");
  ...
  static _log(int priority, String tag, String message) {
    if (_currentLogLevel <= priority) {
      ...
      debugPrint("${_getPriorityText(priority)}${dateFormat.format(DateTime.now())}|$tag|$message");
    }
  }
